...
public class Delete_MaterialPurchase_DelinkPopUpPage_Cancel_Cta_Page extends Base_Page {

	public Delete_MaterialPurchase_DelinkPopUpPage_Cancel_Cta_Page (WebDriver driver) {
		super (driver);
	}
	...
	public void click_materialpurchase_delinkpopuppage()
	{
		try {
			if(materialpurchase_delinkpopuppage_cancel_button.isDisplayed()) {
				click_element(materialpurchase_delinkpopuppage_cancel_button, "delinkpopuppage_cancel_button");
			} else {
	...
	public void click_materialpurchase_editpage_backword_arrow()
	{
		wait.until(ExpectedConditions.elementToBeClickable(materialpurchase_editpage_backword_arrow));
		try {
			click_element(materialpurchase_editpage_backword_arrow, "editpage_backword_arrow");
		} catch(Exception e) {
